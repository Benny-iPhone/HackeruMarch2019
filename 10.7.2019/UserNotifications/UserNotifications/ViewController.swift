...
class ViewController: UIViewController {
    ...
    private func setupNotificationCategories(){
        ...
        let replyAction = UNTextInputNotificationAction(identifier: "reply", title: "לענות", options: [.authenticationRequired], textInputButtonTitle: "שלח לו", textInputPlaceholder: "תכתוב פה משהו")
        let reminderAction = UNNotificationAction(identifier: "reminder", title: "מחר כך", options: [])
        let rejectAction = UNNotificationAction(identifier: "reject", title: "קבל ביטול", options: [.destructive,.authenticationRequired])
        
        let actions = [replyAction,
                       reminderAction,
                       rejectAction]
        
        let eventActionCategory = UNNotificationCategory(identifier: "eventCat", actions: actions, intentIdentifiers: [], options: [])
        let set = Set([eventActionCategory])
    ...
    func createNotification(with text : String, delay : TimeInterval, attachmentUrl : URL? = nil){
        ...
        func request(){
            ...
            content.categoryIdentifier = "eventCat" //flightDetails
